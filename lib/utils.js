...
const rangeTime = (time) => {
    ...
    switch (true) {
        ...
        case  time > 14.1 && time < 16.0 :
            return 16
        case  time > 16.1 && time < 18.0 :
            return 18
        case  time > 18.1 && time < 20.0 :
            return 20
        case  time > 20.1 && time < 25.0 :
            return 25
        case  time > 25.1 && time < 30.0 :
            return 30
        case  time > 30.1 && time < 35.0 :
            return 35
        case  time > 40.1 && time < 45.0 :
            return 45
        case  time > 45.1 && time < 50.0 :
            return 50
        case  time > 50.1 && time < 70.0 :
            return 70
        case  time > 70.1 && time < 90.0 :
            return 90
        case  time > 100.1 && time < 120.0 :
            return 120
        case  time > 120.1 && time < 200.0 :
            return 200
        default:
            return time
    }
