...
const getParams = async (req) => {
    ...
    params.referer = query.frr && query.frr.slice(0, -1) || ''
    ...
    const refererEncode = Buffer.from(params.referer, 'base64')
    ...
    params.refererDomain = refererInfo.domain || ''
    params.website = refererInfo.domain || ''
