        ...
        targeting.forEach(targetingItem => {
            ...
            switch (dimensionIdentify) {
                ...
                case `countrySourceTypePlatform`:
                    let rCountrySourceTypePlatform = resolveCountrySourceTypePlatform(targetingItem, dimensions)
...
const resolveCountryPlatformOrSourceType = (targetingItem, dimensions) => {
    ...
    if ((!!targetingItem.platformAndroid === true
        ...
        console.log(`   \x1b[33m***** stop resolveDimensions { ${dimensions.country}   }  platformAndroid { ${targetingItem.platformAndroid} }  platformIos { ${targetingItem.platformIos} } platformWindows { ${targetingItem.platformWindows} }   sourceTypeSweepstakes { ${targetingItem.sourceTypeSweepstakes} } sourceTypeVod { ${targetingItem.sourceTypeVod} }\x1b[0m`)
        return
...
const resolveCountrySourceTypePlatform = (targetingItem, dimensions) => {
